...
OBSERVATION_MODES = ("combined", "rgb_only", "height_only")
...
class ReproducibleElectrodeInspectionEnv(gym.Env):
    ...
    def _get_observation(self) -> np.ndarray:
        ...
        if self.observation_mode == "rgb_only":
            observation[4:6] = 0.0
        elif self.observation_mode == "height_only":
            observation[2:4] = 0.0
        return observation
